...
### Turn a restaurant PDF or photo menu into clean, accessible, searchable web content.
...
**Digital Presence** · **Repo 05/50** · **No backend. No login. Client data stays local.**
...
**Menu to Web** is a polished, local-first open-source tool from Volta's 50-project OSS division. It helps Student teams supporting restaurants and food-service clients turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
...
Restaurants often have image-only menus that are unreadable, unsearchable, and hard to update.

### The niche

Independent food businesses with outdated menu assets.

### North-star metric

`menu items converted to accessible HTML`
...
flowchart TD
    ...
    Evidence --> Workbench["Menu to Web"]
    Workbench --> Score["Presence readiness"]
    Score --> Cert["v3 production certification"]
    Cert --> A1["Accessible HTML menu"]
    Cert --> A2["Menu CSV"]
    Cert --> A3["Owner review sheet"]
...
flowchart LR
    subgraph Modules["First-class modules"]
        M1["Menu extraction template"]
        M2["Section and item schema"]
        M3["Allergen/accessibility fields"]
        M4["Change log for updates"]
    end
    M1 --> Workbench
    M2 --> Workbench
    M3 --> Workbench
...
|---|---|
| **Domain workbench** | A purpose-built menu editor interface for turn a restaurant pdf or photo menu into clean, accessible, searchable web content. |
...
|---:|---|---|
| 1 | **Menu extraction template** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 2 | **Section and item schema** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 3 | **Allergen/accessibility fields** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 4 | **Change log for updates** | Converts field work into repeatable, reviewable Volta delivery evidence. |

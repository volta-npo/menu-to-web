export const v3 = {
  ...
  "capabilities": [
    "Domain-specific workbench: Accessible Menu Editor",
    "Operational table: Menu items",
  ...
  "releaseChecklist": [
    ...
    "Menu Completeness reaches production threshold",
    "Allergen Review is documented with evidence",
    "Change Readiness has no unresolved blocker",
    "Accessible HTML menu verified",
    "Menu CSV verified",
    "Owner review sheet verified"
  ],
  "operations": [
